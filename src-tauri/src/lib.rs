...
pub fn run() {
    ...
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::codex::codex_router_get_status,
            commands::codex::codex_router_control_service,
            commands::codex::codex_router_install,
            commands::codex::codex_router_update,
            commands::codex::codex_router_enable,
            commands::codex::codex_router_disable,
            commands::codex::codex_router_list_providers,
